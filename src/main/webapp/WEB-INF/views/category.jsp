...
.content-right .row .card-img {
    width: 170px;
    height: 230px;
}

.content-right .row .card-img img {
    width: 165px;
    height: 230px;
}
</style>
	...
	<div class="container-fluid col-md-12">
		...
		<div class="wrapper-tab col-md-12">
			...
			<div class="content-right col-md-9">
				<div class="title">
					<span><strong>${category_name}</strong></span>
				</div>
				<div class="sort">
					<h5>Sắp xếp theo:</h5>
					<ul class="nav">
							...
							<div class="card-body">
								<div class="card-img">
									<span class="product-item__sale ">
										-${product.percentDiscount}% </span> <a
								...
								<div class="center card-title">
									...
									<div class="card-text">
										<span class="price">${product.discount}đ</span> <del
											class="discount ">${product.price}đ</del>
									</div>
								</div>
								<div class="box-hover card-title center">
									...
									</a> <a href="/product/${product.id}-${product.name}"

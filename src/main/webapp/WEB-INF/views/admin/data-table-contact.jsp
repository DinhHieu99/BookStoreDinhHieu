		...
		<div class="dashboard-wrapper">
			<div class="container-fluid  dashboard-content">
				...
				<div class="row">
					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
						<div class="card">
							<h5 class="card-header">Bảng phản hồi</h5>
							<div class="card-body">
										...
										<tbody>
											<c:forEach var="contact" items="${contact}">
												<tr>
													...
													<td><c:if test="${contact.status == true}">
															<span class="badge-dot badge-success mr-1"></span>Đã phản hồi
													</c:if> <c:if test="${contact.status == false}">
															<span class="badge-dot badge-secondary mr-1"></span>Chưa phản hồi
													</c:if></td>
													<td><fmt:formatDate value="${contact.createdDate}"
															pattern="dd/MM/yyyy" /></td>
													<td>
														<div class="btn-group ml-auto">
															<a href="/admin/sendMail/id=${contact.id}"><button
																	class="btn btn-sm btn-outline-light">Phản hồi</button></a>
														</div>
													</td>
												</tr>
											</c:forEach>

							...
							<form modelAttribute="post" method="POST" action="/admin/addPost"
								...
								<div class="form-group row">
									<label class="col-12 col-sm-3 col-form-label text-sm-right">Nội
										dung</label>
									<div class="col-12 col-sm-8 col-lg-6">
										<textarea name="details" required="" class="form-control ckeditor"
											rows="20"></textarea>
								...
								<div class="form-group row">
									<label class="col-12 col-sm-3 col-form-label text-sm-right">Người
										đăng</label>
									<div class="col-12 col-sm-8 col-lg-6">
										<hidden name="admin.id"
											value='<%=session.getAttribute("id")%>' />
										<input name="admin.name" type="text" required=""
											value="<%=session.getAttribute("adminName")%>" placeholder=""
								...
								<div class="form-group row text-right">
									<div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
										...
										<a href="/admin/post"><input type="button" value="Hủy"

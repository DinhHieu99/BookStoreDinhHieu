				...
				<div class="row">
					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
						<div class="card">
							...
							<a href="/admin/add-post"><button
									class="btn btn-sl btn-outline-light "
									style="width: 200px; margin-bottom: 1rem">Thêm tin tức</button></a>
							<div class="card-body">
												...
												<tr>
													...
													<td>
														<div class="btn-group ml-auto">
															<a href="/admin/edit-post/id=${post.id }"><button
																	class="btn btn-sm btn-outline-light">Edit</button></a> <a
																href="/admin/remove-post/${post.id }"><button

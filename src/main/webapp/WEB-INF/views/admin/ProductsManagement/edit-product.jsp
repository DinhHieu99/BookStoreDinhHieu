					...
					<div class="card">
						...
						<div class="card-body">
							<form method="post" action="/admin/edit-product"
								...
								<div class="form-group row">
									<label class="col-12 col-sm-3 col-form-label text-sm-right">Chiết
										khấu phần trăm (%):</label>
									<div class="col-12 col-sm-8 col-lg-6">
								...
								<div class="form-group row">
									<label class="col-12 col-sm-3 col-form-label text-sm-right">Giảm
										giá:</label>
									<div class="col-12 col-sm-8 col-lg-6">
										<input name="discount"  value="${products.discount}"
											class="form-control" />
									</div>
								</div>

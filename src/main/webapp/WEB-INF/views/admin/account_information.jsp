						...
						<div class="card">
							<div class="card-body">
								<div class="user-avatar text-center d-block">
									<img src="${pageContext.request.contextPath}/img/${admin.img}"
										...
										<form action="/admin/edit_account_information" method="post"
											...
											<div class="form-group row">
												<label class="col-12 col-sm-3 col-form-label text-sm-right">Chức
													vụ</label>
												<div class="col-12 col-sm-8 col-lg-6">
													<c:if test="${admin.position == true}">
														<input type="text" required="" id="position"
															placeholder="" value="Quản lý" name="position"
															class="form-control" disabled>
													</c:if>
													<c:if test="${admin.position == false}">
														<input type="text" required="" id="position"
															placeholder="" value="Nhân viên" name="position"
															class="form-control" disabled>
													</c:if>
												</div>
											</div>
											...
											<div class="form-group row text-right">
												<div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
													<button type="submit" id="Save"
														class="btn btn-space btn-primary">Lưu</button>

												...
												<tr>
													...
													<td>
														<div class="btn-group ml-auto">
															<a href="/admin/edit-users/${users.id}"><button
																	class="btn btn-sm btn-outline-light">Edit</button></a> <a
																href="/admin/remove-users/${users.id}"><button
																	class="btn btn-sm btn-outline-light"
																	onclick="return window.confirm('Bạn có chắc chắn muốn xoá tài khoản ${users.name} này không?');">

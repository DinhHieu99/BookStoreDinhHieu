										...
										<tbody>
											<c:forEach var="products" items="${products}">
												<tr>
													...
													<td>${products.view}</td>
													<td><fmt:formatDate value="${products.createDate}"
													...
													<td>
														<div class="btn-group ml-auto">
															<a href="/admin/edit-product/${products.id }"><button
																	class="btn btn-sm btn-outline-light">Edit</button></a> <a
																href="/admin/removeProduct/${products.id}"><button
																	class="btn btn-sm btn-outline-light"
																	onclick="return window.confirm('Bạn có chắc chắn muốn xoá sản phẩm ${products.name} này không?');">

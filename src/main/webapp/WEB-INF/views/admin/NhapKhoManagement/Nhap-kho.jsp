						...
						<div class="page-breadcrumb">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="#"
										class="breadcrumb-link">Kho hàng</a></li>
									<li class="breadcrumb-item active" aria-current="page">Nhập
										thêm sản phẩm</li>
								</ol>
							</nav>
						</div>
			...
			<div class="row">
				...
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="card">
						...
						<div class="card-body">
							<form method="post" action="/admin/nhap-san-pham" modelAttribute="product"
								...
								<div class="form-group row">
									...
									<div class="col-12 col-sm-8 col-lg-6">
										<textarea name="describe" required=""
											class="form-control ckeditor">${products.describe}</textarea>
								...
								<div class="form-group row">
									...
									<div class="col-12 col-sm-8 col-lg-6">
										<input name="soLuongNhap" required="" value=""
											class="form-control" />
									</div>
								</div>
								<div class="form-group row">
									<label class="col-12 col-sm-3 col-form-label text-sm-right">Đơn
										giá:</label>
									<div class="col-12 col-sm-8 col-lg-6">
								...
								<div class="form-group row">
									<label class="col-12 col-sm-3 col-form-label text-sm-right">Chiết khấu phần trăm:</label>
									<div class="col-12 col-sm-8 col-lg-6">
										<input name="percentDiscount" required="" value="${products.percentDiscount}"
											class="form-control" />(%)
									</div>
								</div>
								<div class="form-group row">
								...
								<div class="form-group row">
									...
									<div class="col-12 col-sm-8 col-lg-6">
										<input type="file" value="${products.imgProduct}" placeholder=""
											class="form-control" name="image">
									</div>
								</div>
								<div class="form-group row">
									<label class="col-12 col-sm-3 col-form-label text-sm-right">Nhà cung cấp:</label>
									<div class="col-12 col-sm-8 col-lg-6">
										<select name="nhaCC.id" class="form-control" id="input-select">
								...
								<input type="hidden" value="${products.view}" placeholder=""
											class="form-control" name="view">
								<div class="form-group row text-right">
									<div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
										<button type="submit" class="btn btn-space btn-primary">Lưu</button>
										<a href="/admin/dataTables"><input type="button"
